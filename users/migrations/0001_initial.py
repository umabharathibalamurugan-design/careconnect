    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('resident', 'Resident'), ('guardian', 'Guardian'), ('volunteer', 'Volunteer'), ('security', 'Security Guard'), ('admin', 'Society Admin'), ('superadmin', 'Super Admin')], default='resident', max_length=20)),
